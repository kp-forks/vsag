...
test:                    ## Build and run unit tests.
	...
	cmake --build "${DEBUG_BUILD_DIR}" --parallel ${COMPILE_JOBS}
	"${DEBUG_BUILD_DIR}/tests/unittests" -d yes ${UT_FILTER} --allow-running-no-tests ${UT_SHARD}
	"${DEBUG_BUILD_DIR}/tests/functests" -d yes ${UT_FILTER} --allow-running-no-tests ${UT_SHARD}
	"${DEBUG_BUILD_DIR}/tests/eval_monitor_test" -d yes ${UT_FILTER} --allow-running-no-tests ${UT_SHARD}
